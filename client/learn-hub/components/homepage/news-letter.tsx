        ...
        <motion.div
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    ...
                    <div className="max-w-xl lg:max-w-lg">
                        ...
                        Get the latest articles on learning and education, delivered right to your inbox.
                        </p>
                        ...
                        <button
                            type="submit"
                            className="flex-none rounded-md bg-[#04A3FD] px-3.5 py-2.5 text-sm font-semibold text-black shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
                        >
                            Subscribe
                        </button>
                        </div>
                    ...
                    <dl className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
                        ...
                        <div className="rounded-md bg-white/5 p-2 ring-1 ring-white/10">
                            <CalendarDaysIcon className="h-10 w-10 text-black" aria-hidden="true" />
                        </div>
                        <dt className="mt-4 font-semibold text-black">Weekly articles</dt>
                        <dd className="mt-2 leading-7 text-gray-400">
                            Research and insights on learning and education, delivered straight to your inbox.
                        </dd>
                        </div>
                        <div className="flex flex-col items-start">
                        <div className="rounded-md bg-white/5 p-2 ring-1 ring-white/10">
                            <HandRaisedIcon className="h-10 w-10 text-black" aria-hidden="true" />
                        </div>
