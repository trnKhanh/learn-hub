...
export const HeroImage = () => {
    ...
    return (
        <div ref={ref} className="mt-[10rem] [perspective:2000px]">
        <div
            className={classNames(
            "relative rounded-lg border border-transparent-white bg-black bg-hero-gradient",
        ...
        >
            ...
            className={classNames(
                ...
                "[&_path]:stroke-black [&_path]:[strokeOpacity:0.2] [&_path]:[stroke-dasharray:1] [&_path]:[stroke-dashoffset:1]",
